<div class="container">
    <div class="footer">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 links">
            <h3>TERMS</h3>
            <ul>
                <li><a href="{{URL('/customer-terms-and-conditions')}}">Customer Terms and Conditions</a></li>
                <li><a href="{{URL('/limited-warranty')}}">Limited Warranty</a></li>
                <li><a href="{{URL('/privacy-policy')}}">Privacy Policy</a></li>
                <li><a href="{{URL('/trademark-usage-policy')}}">Trademark Usage Policy</a></li>
            </ul>
            
            <h3>DOWNLOAD OUR APP</h3>
            
            <a href="https://itunes.apple.com/in/app/unclefitter/id1293842199?mt=8" target="_blank">
                <img class="store-badge" src="{{asset('web/img/app_store_badge.svg')}}" alt="App Store Badge" />
            </a>
            
            <a href="https://play.google.com/store/apps/details?id=com.unclefitter" target="_blank">
                <img class="store-badge" src="{{asset('web/img/play_store_badge.png')}}" alt="Google Play Store Badge" />
            </a>
...
<div class="container">
    <div class="footter">
        <div class="col-md-8 col-sm-8 col-xs-12 reserved">
            <p>© <?php echo date('Y'); ?> Uncle Fitter All rights reserved.</p>
        </div>
